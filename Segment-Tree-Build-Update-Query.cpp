...
void swap1( int &a , int &b , int &c ) ; 	                // Rotate this array one times
void swap2( int &a , int &b , int &c ) ;	                // Rotate this array two times
void propagate( int at , int low , int high ) ;             // Handle the lazy operation and rotate 
void Build( int at , int low , int high ) ;			        // Building the array
void Update( int at , int low , int high , int l , int r ) ;// Update the array in this given range L-R
int Query( int at , int low , int high , int l , int r ) ;  // Caculate result between given range L-R
void reset() ;	                                            // Reset the seg 2D array and lazy array because of the other test case operation
